...
function Resultspersubject () {
    ...
    const fetchstudent = () => {
        ...
        router.push(`/admin/Results/Results-per-subject-report?stclass=${studentclass}&termid=${term}`);
    }
    ...
    return (
      ...
      <SafeAreaView>
        <Stack.Screen options={{
            headerTitle: 'Results per subject'
        }}
        />
        <ScrollView
        refreshControl={
...
export default Resultspersubject;
