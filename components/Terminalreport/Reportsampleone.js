...
import { Table, Row, Rows, TableWrapper, Col } from 'react-native-table-component';
  ...
  function Reportsampleone ({termid,stclassid,term,stclass,from,to}) {
    ...
    const loaddata = () => {
      ...
      axios.get(schoolzapi+`/report-sample-one/${termid}/${stclassid}/${from}/${to}`,
      {
...
return (
    ...
    export default Reportsampleone;
