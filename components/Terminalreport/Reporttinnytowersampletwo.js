...
import { Table, Row, Rows, TableWrapper, Col } from 'react-native-table-component';
  ...
  function Reporttinnytowersampletwo ({termid,stclassid,term,stclass,from,to}) {
    ...
    const loaddata = () => {
      ...
      axios.get(schoolzapi+`/report-sample-two-tinnytower/${termid}/${stclassid}`,
      {
...
return (
    ...
    export default Reporttinnytowersampletwo;
