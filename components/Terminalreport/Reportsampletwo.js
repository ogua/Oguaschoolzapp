...
import { Table, Row, Rows, TableWrapper, Col } from 'react-native-table-component';
  ...
  function Reportsampletwo ({termid,stclassid,term,stclass,from,to}) {
    ...
    const loaddata = () => {
      ...
      axios.get(schoolzapi+`/report-sample-two/${termid}/${stclassid}/${from}/${to}`,
      {
...
return (
    ...
    export default Reportsampletwo;
