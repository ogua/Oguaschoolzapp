        ...
        return Alert.alert(
            ...
            [
              ...
              },
              {
                ...
                onPress: () => {
                    setLoading(true);
                    axios.delete(schoolzapi+'/vendors/'+id,
                    {
                        headers: {Accept: 'application/json',
                        Authorization: "Bearer "+token
                    }
    ...
    return (
      ...
      <SafeAreaView style={{flexGrow: 1}}>
        ...
        {/* {isloading ? null : (
           <View style={{marginVertical: 20}}>
                <View style={{flexDirection: 'row',justifyContent: 'flex-end', marginHorizontal: 20}}>
                    ...
                    <TouchableOpacity style={{flexDirection: 'row'}} onPress={()=> router.push('/admin/Accounts/create-edit-vendors')}>
            ...
            <Card>
                ...
                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <Vendorlist item={item} deletedata={deletedata} /> }
        ...
        <FAB
          icon="plus"
          style={styles.fab}
          onPress={()=> router.push('/admin/Accounts/create-edit-vendors')}
        />
