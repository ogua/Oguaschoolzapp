...
import Receipttracklist from '../../lists/Receipttracklist';

function Receipttrack () {
    ...
    const loaddata = () => {
        ...
        axios.get(schoolzapi+'/receipt-track',
        {
        ...
        return Alert.alert(
            ...
            [
              ...
              },
              {
                ...
                onPress: () => {
                    setLoading(true);
                    axios.delete(schoolzapi+'/receipt-track/'+id,
                    {
                        headers: {Accept: 'application/json',
                        Authorization: "Bearer "+token
                    }
      ...
      const searchFilterFunction = (text) => {
          ...
          if (text) {
            ...
            const newData = data.filter(function (item) {
              const itemData = item.receptid
                ? item.receptid.toUpperCase()
                : ''.toUpperCase();
      ...
      <SafeAreaView>
       ...
       <Searchbar
        ...
        > 
                ...
                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <Receipttracklist item={item} deletedata={deletedata} /> }
