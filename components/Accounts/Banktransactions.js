...
import Chartofaccountlist from '../../lists/Chartofaccountlist';
import Banktransactionlist from '../../lists/Branktransactionlist';
...
function Banktransaction () {
    ...
    const loaddata = () => {
        setLoading(true);
        axios.get(schoolzapi+'/bank-transactions',
        {
        ...
        return Alert.alert(
            ...
            [
              ...
              },
              {
                ...
                onPress: () => {
                    setLoading(true);
                    axios.delete(schoolzapi+'/bank-transactions/'+id,
                    {
                        headers: {Accept: 'application/json',
                        Authorization: "Bearer "+token
                    }
        ...
        {isloading ? null : (
           <View style={{marginVertical: 20}}>
                <View style={{flexDirection: 'row',justifyContent: 'flex-end', marginHorizontal: 20}}>
                    ...
                    <TouchableOpacity style={{flexDirection: 'row'}} onPress={()=> router.push('/admin/Accounts/create-edit-bank-transaction')}>
            ...
            <Card>
                ...
                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <Banktransactionlist item={item} deletedata={deletedata} /> }
