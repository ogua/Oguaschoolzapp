        ...
        return Alert.alert(
            ...
            [
              ...
              },
              {
                ...
                onPress: () => {
                    setLoading(true);
                    axios.delete(schoolzapi+'/calllogs/'+id,
                    {
                        headers: {Accept: 'application/json',
                        Authorization: "Bearer "+token
                    }
    ...
    return (
      ...
      <SafeAreaView style={{flexGrow: 1}}>
          ...
          <>
           {/* <View style={{marginVertical: 20}}>
                <View style={{flexDirection: 'row',justifyContent: 'flex-end', marginHorizontal: 20}}>
                    ...
                    <TouchableOpacity style={{flexDirection: 'row'}} onPress={()=> router.push('/admin/Frontdesk/create-edit-calllog')}>
            ...
            <Card>
                ...
                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <Callloglist item={item} deletedata={deletedata} /> }
        ...
        <FAB
          icon="plus"
          style={styles.fab}
          onPress={()=> router.push('/admin/Frontdesk/create-edit-calllog')}
        />
