...
import Postalreceivedlist from '../../lists/Postalreceivedlist';

function Postalreceived () {
    ...
    const loaddata = () => {
        setLoading(true);
        axios.get(schoolzapi+'/postal-received',
        {
        ...
        return Alert.alert(
            ...
            [
              ...
              },
              {
                ...
                onPress: () => {
                    setLoading(true);
                    axios.delete(schoolzapi+'/postal-received/'+id,
                    {
                        headers: {Accept: 'application/json',
                        Authorization: "Bearer "+token
                    }
        ...
        {isloading ? null : (
           <View style={{marginVertical: 20}}>
            ...
            <Card>
                ...
                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <Postalreceivedlist item={item} deletedata={deletedata} /> }
