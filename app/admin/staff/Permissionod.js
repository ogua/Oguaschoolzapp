...
import Permissionlist from '../../../lists/Permissionlist';


function Permissionsold () {
                ...
                <Card.Content>
                    {Loading ? <ActivityIndicator size="large" /> : (
                        <View>
                            ...
                            <FlatList
                                data={data}
                                renderItem={({item})=> <Permissionlist item={item} permission={permission} addpermission={addpermission} /> }
...
export default React.memo(Permissionsold);
