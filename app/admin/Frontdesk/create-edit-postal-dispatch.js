...
const hideDialog = () => setShowdialog(false);
    ...
    useEffect(()=>{
      ...
      if(id == undefined){
        isCreatedorEdit('New Dispatch');
      }else{
        loaddata();
        isCreatedorEdit('Edit Dispatch');
      }
    ...
    const loaddata = () => {
      ...
      axios.get(schoolzapi+'/postal-dispatch/show/'+id,
      {
    ...
    const createdata = () => {
        ...
        axios.post(schoolzapi+'/postal-dispatch',
        data,
        {
            headers: {Accept: 'application/json',
    ...
    const updatedata = () => {
      ...
      axios.post(schoolzapi+'/postal-dispatch/'+id,
      data,
      {
          headers: {Accept: 'application/json',
          'Content-Type': 'multipart/form-data',
...
export default Createeditpostaldispatch;
