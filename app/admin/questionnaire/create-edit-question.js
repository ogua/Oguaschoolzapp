...
function Createeditquestions () {
    ...
    useEffect(()=>{
      ...
      const loaddataedit = () => {
        ...
        axios.get(schoolzapi+'/add-questionnaire/show/'+id,
        {
    ...
    const createdata = () => {
        ...
        axios.post(schoolzapi+'/add-questionnaire',
        formdata,
        {
            headers: {Accept: 'application/json',
            Authorization: "Bearer "+token
    ...
    const updatedata = () => {
        ...
        axios.patch(schoolzapi+'/add-questionnaire/'+id,
        formdata,
        {
            headers: {Accept: 'application/json',
            Authorization: "Bearer "+token
...
export default Createeditquestions;
