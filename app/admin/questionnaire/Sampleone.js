...
function Samplequestionnaireone () {
    ...
    useEffect(()=>{
        ...
        if(id == undefined){
          isCreatedorEdit('Questionnaire 1');
          
        }else{
          loaddataedit();
          isCreatedorEdit('Edit Questionnaire 1');
        }
      ...
      const loaddataedit = () => {
        ...
        axios.get(schoolzapi+'/questionnaire-one/show/'+id,
        {
    ...
    const createdata = () => {
        ...
        axios.post(schoolzapi+'/questionnaire-one',
        formdata,
        {
            headers: {Accept: 'application/json',
            Authorization: "Bearer "+token
    ...
    const updatedata = () => {
        ...
        axios.patch(schoolzapi+'/questionnaire-one/'+id,
        formdata,
        {
            headers: {Accept: 'application/json',
            Authorization: "Bearer "+token
...
export default Samplequestionnaireone;
