...
function Samplequestionnairetwo () {
    ...
    useEffect(()=>{
        ...
        if(id == undefined){
          isCreatedorEdit('Questionnaire 2');
          
        }else{
          loaddataedit();
          isCreatedorEdit('Edit Questionnaire 2');
        }
      ...
      const loaddataedit = () => {
        ...
        axios.get(schoolzapi+'/questionnaire-two/show/'+id,
        {
        ...
        .then(function (results) {
            setLoading(false);
            setstudentclass(parseInt(results.data.data.stclass));
            setterm(parseInt(results.data.data.term));
    ...
    const createdata = () => {
        ...
        axios.post(schoolzapi+'/questionnaire-two',
        formdata,
        {
            headers: {Accept: 'application/json',
            Authorization: "Bearer "+token
    ...
    const updatedata = () => {
        ...
        axios.patch(schoolzapi+'/questionnaire-two/'+id,
        formdata,
        {
            headers: {Accept: 'application/json',
            Authorization: "Bearer "+token
...
export default Samplequestionnairetwo;
