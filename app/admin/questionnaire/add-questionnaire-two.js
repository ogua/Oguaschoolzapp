...
import Questionnaireaddlist from '../../../lists/Questionnaireaddlist';
import Questionnaireaddtwolist from '../../../lists/Questionnaireaddtwolist';

function Addquestionnairetwo () {
    ...
    const {qid,term,stclass} = useSearchParams();
    ...
    const loaddata = () => {
        setLoading(true);
        axios.get(schoolzapi+'/questionnaire-two-questions/'+qid,
        {
        ...
        return Alert.alert(
            ...
            [
              ...
              },
              {
                ...
                onPress: () => {
                    setLoading(true);
                    axios.delete(schoolzapi+'/questionnaire-two-questions/'+id,
                    {
                        headers: {Accept: 'application/json',
                        Authorization: "Bearer "+token
                    }
       ...
       <Stack.Screen options={{
           ...
           <View style={{marginVertical: 20}}>
                <View style={{flexDirection: 'row',justifyContent: 'flex-end', marginHorizontal: 20}}>
                    ...
                    <TouchableOpacity style={{flexDirection: 'row'}} onPress={()=> router.push(`/admin/questionnaire/create-edit-que-two?qid=${qid}&term=${term}&stclass=${stclass}`)}>
        ...
        >
            ...
            <Card>
                ...
                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <Questionnaireaddtwolist item={item} deletedata={deletedata} qid={qid} /> }
...
export default Addquestionnairetwo;
