...
function Createeditteacinglog() {
    ...
    const loaddata = () => {
      ...
      axios.get(schoolzapi+'/subject',
      {
        ...
        loassubjects(results.data.data);
  ...
  const loassubjects = (data) => {
    ...
    const loadedit = () => {
      ...
      axios.get(schoolzapi+'/teaching-logs/show/'+id,
      {
          headers: {Accept: 'application/json',
          Authorization: "Bearer "+token
      }
        ...
        // console.log(results.data.data.status);
          ...
          setIntime(results.data.data.starttime);
          setOuttime(results.data.data.endtime);
          settrandate(results.data.data.startdate);
    ...
    const createdata = () => {
        ...
        if(intime == ""){
          alert('From Time cant be empty');
          return;
        }

        if(outtime == ""){
          alert('To Time cant be empty');
          return;
        }
      ...
      const formdata = {
        ...
        axios.post(schoolzapi+'/teaching-logs',
        formdata,
        {
            headers: {Accept: 'application/json',
            Authorization: "Bearer "+token
    ...
    const formdata = {
      ...
      axios.patch(schoolzapi+'/teaching-logs/'+id,
      formdata,
      {
          headers: {Accept: 'application/json',
          Authorization: "Bearer "+token
