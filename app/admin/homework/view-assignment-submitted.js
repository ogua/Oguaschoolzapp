...
import AssignmentsubList from '../../../lists/AssignmentsubList';
    ...
    return (
      ...
      <SafeAreaView>
        <Stack.Screen options={{
            headerTitle: 'Assignments Submitted',
            headerLeft: () => (
                <>
        ...
        >
            <Card>
                <Card.Content>
                <Button onPress={()=> router.push(`/admin/homework/enter-assignment-score?stclass=${stclass}&assigmtid=${assigmtid}`)}>Enter Score</Button>

                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <AssignmentsubList item={item}  /> }
